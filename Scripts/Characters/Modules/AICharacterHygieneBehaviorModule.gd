...
func _get_shower_use_cell(shower: Node2D) -> Vector2i:
	var start_cell := _get_current_or_nearest_walkable_top_left_cell(false)
	return _get_shower_use_cell_with_distance_map(shower, _get_grid_distance_map(start_cell))


func _get_shower_use_cell_with_distance_map(shower: Node2D, distance_map: Dictionary) -> Vector2i:
