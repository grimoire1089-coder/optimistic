extends Node2D
class_name ShowerFurniture

@export var display_name: String = "シャワー"
@export var furniture_id: StringName = &"shower"
...
@export var fallback_base_color: Color = Color(0.04, 0.05, 0.06, 1.0)
@export var fallback_edge_color: Color = Color(0.05, 0.95, 1.0, 0.92)
@export var fallback_inner_color: Color = Color(0.12, 0.14, 0.16, 1.0)
@export var restores_hygiene: bool = true
...
func _draw() -> void:
	...
	draw_rect(inset_rect, Color(fallback_edge_color.r, fallback_edge_color.g, fallback_edge_color.b, 0.26), false, 1.5)
...
func can_restore_hygiene() -> bool:
	return restores_hygiene
