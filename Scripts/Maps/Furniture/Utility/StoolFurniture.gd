extends Node2D
class_name StoolFurniture

@export var display_name: String = "Stool"
@export var furniture_id: StringName = &"stool"
@export var grid_footprint: Vector2i = Vector2i(2, 2)
...
@export var fallback_base_color: Color = Color(0.35, 0.22, 0.14, 1.0)
@export var fallback_edge_color: Color = Color(0.85, 0.62, 0.32, 1.0)
@export var fallback_seat_color: Color = Color(0.48, 0.31, 0.18, 1.0)
@export var sit_target_offset: Vector2 = Vector2.ZERO
...
func _draw() -> void:
	...
	var seat_rect := rect.grow(-8.0)
	draw_rect(rect, fallback_base_color, true)
	draw_rect(rect, fallback_edge_color, false, 2.0)
	draw_rect(seat_rect, fallback_seat_color, true)
	draw_rect(seat_rect, fallback_edge_color, false, 1.5)
...
func get_sit_target_global_position() -> Vector2:
	return global_position + sit_target_offset
